...
class SilverGoodsController extends Controller
{
    use ModelForm;
    ...
    public function show($id)
    {
        return Admin::content(function (Content $content) use ($id)
        {
            ...
            $content->header('银币商品查看');
            $content->breadcrumb(
                ['text' => '银币商品管理', 'url' => '/silverGoods'],
                ['text' => '银币商品查看']
            );
    ...
    {
        return Admin::grid(SilverGoods::class, function (Grid $grid)
        {
    ...
    {
        return Admin::form(SilverGoods::class, function (Form $form)
        {
